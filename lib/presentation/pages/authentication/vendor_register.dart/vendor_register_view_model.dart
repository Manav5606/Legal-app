...
final _vendorViewModel = ChangeNotifierProvider.autoDispose(
    (ref) => VendorRegisterViewModel(ref.read(AppState.auth.notifier)));
...
class VendorRegisterViewModel extends BaseViewModel {
  ...
  VendorRegisterViewModel(this._authProvider);
  ...
  void clearError() {
    usernameError = passwordError =
        password1Error = emailError = numberError = otpError = null;
    notifyListeners();
  }
